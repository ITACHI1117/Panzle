  ...
  return (
    <div className="max-w-7xl mx-auto px-8 py-16">
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
        {/* Left Column - Content */}
        <div className="space-y-8 items-center md:items-start flex flex-col">
          <div>
          ...
          <p className="text-muted-foreground text-md md:text-lg max-w-lg text-center md:text-left   font-Inter">
          ...
          {/* Review Section */}
          <div className="pt-1 space-y-4 flex flex-col items-center md:items-start">
            ...
            <p className="text-muted-foreground text-center md:text-left italic md:max-w-md font-Inter">
